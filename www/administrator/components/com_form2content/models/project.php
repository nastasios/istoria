...
{	
	...
	private function createSampleFormTemplateClassic($contentType)
	{
		...
		if($contentType->settings['associations_front_end'])
		{
			$template .= 	'<tr class="f2c_field f2c_associations">
								<td valign="top" class="f2c_field_label">{$F2C_ASSOCIATIONS_CAPTION}</td>
								<td valign="top" class="f2c_field_value">{$F2C_ASSOCIATIONS}</td>
							</tr>'.PHP_EOL;
		}
	...
	private function createSampleFormTemplateModern($contentType)
	{
		...
		if($contentType->settings['associations_front_end'])
		{
			$template .= 	'<div class="control-group f2c_field f2c_associations">
								<div class="control-label f2c_field_label">{$F2C_ASSOCIATIONS_CAPTION}</div>
								<div class="controls f2c_field_value">{$F2C_ASSOCIATIONS}</div>
							</div>'.PHP_EOL;
		}
