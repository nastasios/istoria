			...
			<div class="width-60 fltlft">
				...
				<?php if($this->assoc) : ?>
					<tr class="f2c_field f2c_associations">
						<td valign="top" class="f2c_field_label"><?php echo $this->contentTypeSettings->get('associations_caption', JText::_('JGLOBAL_FIELDSET_ASSOCIATIONS')); ?></td>
						<td valign="top" class="f2c_field_value"><?php echo $this->loadTemplate('associations'); ?></td>
					</tr>
				<?php endif; ?>							
				<?php
				// User defined fields
