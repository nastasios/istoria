	...
	<div id="f2c_form" class="content_type_<?php echo $this->item->projectid; ?>">
		...
		?>
			...
			<div class="row-fluid form-horizontal">
				...
				<?php endif; ?>	
				<?php if($this->assoc) : ?>
					<div class="control-group f2c_field f2c_associations">
						<div class="control-label f2c_field_label"><?php echo $this->contentTypeSettings->get('associations_caption', JText::_('JGLOBAL_FIELDSET_ASSOCIATIONS')); ?></div>
						<div class="controls f2c_field_value"><?php echo $this->loadTemplate('associations'); ?></div>
					</div>
				<?php endif; ?>			
