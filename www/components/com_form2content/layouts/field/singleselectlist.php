...
{
	echo JHTMLSelect::genericlist($displayData['listOptions'], $field->elementId, $field->settings->get('ssl_attributes'), 'value', 'text', $field->values['VALUE']);
}
else
{
	?>
	<fieldset class="radio">
		<?php echo JHTML::_('select.radiolist', $displayData['listOptions'], $field->elementId, 'class="radiobutton"', 'value', 'text', $field->values['VALUE']); ?>
	</fieldset>
	<?php 
}
?>
